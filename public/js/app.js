...
$(document).on('click', '.card-actions a', function (e) {
    ...
    if ($(_this).hasClass('btn-close')) {
        $(_this).parent().parent().parent().fadeOut();
    } else if ($(_this).hasClass('btn-minimize')) {
        var $target = $(_this).parent().parent().next('.card-block');

        if (!$(_this).hasClass('collapsed')) {
            $('i', $(_this)).removeClass($.panelIconOpened).addClass($.panelIconClosed);
        } else {
            $('i', $(_this)).removeClass($.panelIconClosed).addClass($.panelIconOpened);
        }
    } else if ($(_this).hasClass('btn-setting')) {
        $('#myModal').modal('show');
    }
});
